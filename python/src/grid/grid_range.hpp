...
void add_grid_range(py::module_& m) 
{
    ...
    py::class_<gr_t>(m, "GridRange")
        ...
        .def("n_tiles", 
                py::overload_cast<size_t>(&gr_t::n_tiles, py::const_))
        .def("n_tiles", 
                py::overload_cast<>(&gr_t::n_tiles, py::const_))
        .def("n_gridpts", &gr_t::n_gridpts)
        .def("n_params", &gr_t::n_params)
        .def("thetas", 
                py::overload_cast<>(&gr_t::thetas), 
                py::return_value_policy::reference_internal)
        .def("thetas_const", 
                py::overload_cast<>(&gr_t::thetas, py::const_),
                py::return_value_policy::reference_internal)
        .def("radii",
                py::overload_cast<>(&gr_t::radii),
                py::return_value_policy::reference_internal)
        .def("radii_const",
                py::overload_cast<>(&gr_t::radii, py::const_),
                py::return_value_policy::reference_internal)
        .def("sim_sizes",
                py::overload_cast<>(&gr_t::sim_sizes),
                py::return_value_policy::reference_internal)
        .def("sim_sizes_const",
        ...
        .def(py::pickle(
            ...
            [](py::tuple t) { // __setstate__
                ...
                using t_t = std::decay_t<decltype(std::declval<gr_t>().thetas())>;
                using r_t = std::decay_t<decltype(std::declval<gr_t>().radii())>;

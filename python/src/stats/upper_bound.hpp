...
void add_upper_bound(py::module_& m)
{
    ...
    py::class_<ub_t>(m, "UpperBound")
        .def(py::init<>())
        .def("create", &ub_t::template create<
                model_base_t,
                is_t,
                gr_t>,
        ...
        .def("delta_0", 
                ...
                py::return_value_policy::reference_internal)
        .def("delta_0_const", 
                py::overload_cast<>(&ub_t::delta_0, py::const_),
                py::return_value_policy::reference_internal)
        .def("delta_0_u", 
                py::overload_cast<>(&ub_t::delta_0_u),
                py::return_value_policy::reference_internal)
        .def("delta_0_u_const", 
                py::overload_cast<>(&ub_t::delta_0_u, py::const_),
                py::return_value_policy::reference_internal)
        .def("delta_1", 
                py::overload_cast<>(&ub_t::delta_1),
                py::return_value_policy::reference_internal)
        .def("delta_1_const", 
                py::overload_cast<>(&ub_t::delta_1, py::const_),
                py::return_value_policy::reference_internal)
        .def("delta_1_u", 
                py::overload_cast<>(&ub_t::delta_1_u),
                py::return_value_policy::reference_internal)
        .def("delta_1_u_const", 
                py::overload_cast<>(&ub_t::delta_1_u, py::const_),
                py::return_value_policy::reference_internal)
        .def("delta_2_u", 
                py::overload_cast<>(&ub_t::delta_2_u),
                py::return_value_policy::reference_internal)
        .def("delta_2_u_const", 

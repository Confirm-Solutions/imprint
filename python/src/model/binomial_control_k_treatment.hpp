        ...
        .def(py::pickle(
            [](const bckt_t& p) {  // __getstate__
                ...
                return py::make_tuple(
                    ...
                    // p.probs(),
                    // p.gbits(),
                    p.thresholds(), p.n_arms(), p.ph2_size(), p.n_samples());
            },
            [](py::tuple t) {  // __setstate__
                ...
                auto&& thresh =
                    t[4 - 4]
                        .cast<std::decay_t<
                            decltype(std::declval<bckt_t>().thresholds())>>();
                bckt_t p(t[5 - 4].cast<size_t>(), t[6 - 4].cast<size_t>(),
                         t[7 - 4].cast<size_t>(), thresh);

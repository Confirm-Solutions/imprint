...
common_parser.add_argument('--arms', type=int, nargs='?',
                    default=arms_def,
                    help=f'Number of arms (default: {arms_def}).')
common_parser.add_argument('--phase2', type=int, nargs='?',
                    default=phase2_def,
                    help=f'Phase II size (default: {phase2_def}).')
...
logger.info("ph2_size: {}".format(ph2_size))
...
# create model
model = SimpleSelection(n_arms, n_samples, ph2_size, [])
    ...
    while 1:
        ...
        if do_plot:
            ...
            if n_arms == 3:
                ...
                logger.info("No plotting mechanism implemented for the current configuration.")

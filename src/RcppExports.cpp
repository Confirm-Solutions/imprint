...
// bckt_tune
List bckt_tune(int n_sim, double alpha, double delta, int ph2_size, int n_samples, int grid_dim, double grid_radius, const Eigen::Map<Eigen::VectorXd> p, const Eigen::Map<Eigen::MatrixXd> p_endpt, const Eigen::Map<Eigen::VectorXd> lmda_grid, int start_seed, int p_batch_size, int n_thr, bool do_progress_bar);
...
// eckt_tune
List eckt_tune(int n_sim, double alpha, double delta, int n_samples, double grid_radius, double censor_time, const Eigen::Map<Eigen::VectorXd> lmda, const Eigen::Map<Eigen::VectorXd> lmda_lower, const Eigen::Map<Eigen::VectorXd> hzrd_rate, const Eigen::Map<Eigen::VectorXd> hzrd_rate_lower, const Eigen::Map<Eigen::VectorXd> thr_vec, int start_seed, int p_batch_size, int n_thr, bool do_progress_bar);
RcppExport SEXP _kevlar_eckt_tune(SEXP n_simSEXP, SEXP alphaSEXP, SEXP deltaSEXP, SEXP n_samplesSEXP, SEXP grid_radiusSEXP, SEXP censor_timeSEXP, SEXP lmdaSEXP, SEXP lmda_lowerSEXP, SEXP hzrd_rateSEXP, SEXP hzrd_rate_lowerSEXP, SEXP thr_vecSEXP, SEXP start_seedSEXP, SEXP p_batch_sizeSEXP, SEXP n_thrSEXP, SEXP do_progress_barSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type n_sim(n_simSEXP);
    ...
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::VectorXd> >::type lmda(lmdaSEXP);
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::VectorXd> >::type lmda_lower(lmda_lowerSEXP);
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::VectorXd> >::type hzrd_rate(hzrd_rateSEXP);
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::VectorXd> >::type hzrd_rate_lower(hzrd_rate_lowerSEXP);
    Rcpp::traits::input_parameter< const Eigen::Map<Eigen::VectorXd> >::type thr_vec(thr_vecSEXP);
    Rcpp::traits::input_parameter< int >::type start_seed(start_seedSEXP);
    Rcpp::traits::input_parameter< int >::type p_batch_size(p_batch_sizeSEXP);
    Rcpp::traits::input_parameter< int >::type n_thr(n_thrSEXP);
    Rcpp::traits::input_parameter< bool >::type do_progress_bar(do_progress_barSEXP);
    rcpp_result_gen = Rcpp::wrap(eckt_tune(n_sim, alpha, delta, n_samples, grid_radius, censor_time, lmda, lmda_lower, hzrd_rate, hzrd_rate_lower, thr_vec, start_seed, p_batch_size, n_thr, do_progress_bar));
    return rcpp_result_gen;
END_RCPP
}
// eckt_fit
void eckt_fit(int n_sim, double delta, int n_samples, double grid_radius, double censor_time, const Eigen::Map<Eigen::VectorXd> lmda, const Eigen::Map<Eigen::VectorXd> lmda_lower, const Eigen::Map<Eigen::VectorXd> hzrd_rate, const Eigen::Map<Eigen::VectorXd> hzrd_rate_lower, double thr, String serialize_fname, int start_seed, int p_batch_size, int n_thr, bool do_progress_bar);
RcppExport SEXP _kevlar_eckt_fit(SEXP n_simSEXP, SEXP deltaSEXP, SEXP n_samplesSEXP, SEXP grid_radiusSEXP, SEXP censor_timeSEXP, SEXP lmdaSEXP, SEXP lmda_lowerSEXP, SEXP hzrd_rateSEXP, SEXP hzrd_rate_lowerSEXP, SEXP thrSEXP, SEXP serialize_fnameSEXP, SEXP start_seedSEXP, SEXP p_batch_sizeSEXP, SEXP n_thrSEXP, SEXP do_progress_barSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type n_sim(n_simSEXP);
    Rcpp::traits::input_parameter< double >::type delta(deltaSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type n_thr(n_thrSEXP);
    Rcpp::traits::input_parameter< bool >::type do_progress_bar(do_progress_barSEXP);
    eckt_fit(n_sim, delta, n_samples, grid_radius, censor_time, lmda, lmda_lower, hzrd_rate, hzrd_rate_lower, thr, serialize_fname, start_seed, p_batch_size, n_thr, do_progress_bar);
    return R_NilValue;
END_RCPP
}
// unserialize

...
protected:
    ...
    {
        for (orient_type it1 = orient_type::begin;
                it1 != orient_type::end;
                ++it1)
        {
            for (orient_type it2 = orient_type::begin;
                    it2 != orient_type::end;
                    ++it2)
            {
...
{
    const std::unordered_map<orient_type, std::unordered_set<orient_type>> true_tab = {
...
{
    const std::unordered_map<orient_type, std::unordered_set<orient_type>> true_tab = {
        {orient_type::pos, {orient_type::non_neg, orient_type::non_on, orient_type::pos}},
        {orient_type::on,  {orient_type::non_neg, orient_type::non_pos, orient_type::on}},
        {orient_type::neg, {orient_type::non_pos, orient_type::non_on, orient_type::neg}},

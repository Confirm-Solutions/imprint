...
Note that $U_2(v) = 0$ for any linear transformation $\eta$.
In particular, for the identity transformation, it simplifies to the usual formula
\begin{align*}
    U(v) = U_1(v) = v^\top \sup\limits_{\theta \in R} \var{T_{\tau_{\max}}}_\eta v
\end{align*}
...
\[
    ...
    1-\delta_2
\]
by convexity of $U$ and that $R$ is a convex hull.

/*
From https://github.com/haranjackson/LegendreGauss
Under MIT license
*/
#include <Eigen/Dense>
#include <Eigen/Eigen>
...
inline Arr legval(
    ...
    Vec c) { /*
             ...
             terms of degree n are contained in c[n].
...
inline Vec legder(
    Vec c) { /*
             ...
             degree, e.g. [1,2,3] represents the series ``1*L_0 + 2*L_1 +
             3*L_2``.
             ...
             not resemble the same operation on a power series. Thus the result
             of this function may be "unintuitive," albeit correct.
             */

...
struct Exponential {
   ...
   public:
    ...
    KEVLAR_STRONG_INLINE void sample(size_t m, size_t n, GenType&& gen,
                                     OutType&& out) {
    ...
    KEVLAR_STRONG_INLINE static auto covar_quadform(const NType& n,
                                                    const LmdaType& lmda,
                                                    const VType& v) {
    ...
    KEVLAR_STRONG_INLINE static auto score(const TType& t, const NType& n,
                                           const LmdaType& lmda) {
        return t - n * (1 / lmda);
    }

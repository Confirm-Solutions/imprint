 ...
 * a Type I error kevlar bound.
 * It stores all necessary components of the kevlar bound.
 *
...
struct TypeIErrorBound {
   ...
   private:
    // Components that make up the kevlar bound.
   ...
   public:
    /*
     * Creates and stores the components of the kevlar bound.
     *
     * @param   kbs                 KevlarBoundState-like object.
